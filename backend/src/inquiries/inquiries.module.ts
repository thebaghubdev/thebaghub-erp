...
import { ClientConsignmentSchedulesController } from './client-consignment-schedules.controller';
...
@Module({
  ...
  controllers: [
    InquiriesController,
    ClientConsignmentInquiryController,
    ClientConsignmentSchedulesController,
  ],
