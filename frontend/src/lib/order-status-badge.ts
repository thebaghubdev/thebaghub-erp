...
const BY_STATUS: Record<string, string> = {
  ...
  "for credit line approval": "text-amber-800 dark:text-amber-300",
  ...
  "item received - unpaid": "text-amber-800 dark:text-amber-300",
  "item received - paid": "text-emerald-800 dark:text-emerald-300",
